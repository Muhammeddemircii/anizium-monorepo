...
export default function EditProfilePage() {
  const [name, setName] = useState('Metehan')
  const [isKids, setIsKids] = useState(false)
  const [selectedAvatar, setSelectedAvatar] = useState('/assets/avatars/avatar-1.png')
  const [showAvatarSelector, setShowAvatarSelector] = useState(false)

  const handleSave = () => {
    // Profil güncelleme işlemleri burada yapılacak
    console.log('Profil güncellendi:', { name, isKids, avatar: selectedAvatar })
  }
        ...
        >
          <div className="grid gap-8 md:grid-cols-[200px,1fr]">
            ...
            <div className="flex flex-col items-center">
              <div className="group relative mb-4 aspect-square w-full overflow-hidden rounded-lg">
                <Image
                  src={selectedAvatar}
                  alt="Profil Avatarı"
                  fill
          ...
          <div className="mt-8 flex justify-end space-x-4 border-t border-gray-800 pt-8">
            ...
            <Button onClick={handleSave} className="bg-primary-red hover:bg-primary-red/90">
              Kaydet
            </Button>
          </div>
        </motion.div>
